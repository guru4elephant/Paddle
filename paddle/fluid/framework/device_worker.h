...
class PullDenseWorker {
 public:
  ...
  void Wait(const std::vector<::std::future<int32_t>>* status_vec);
 private:
  void Run();
 ...
 private:
  ...
  std::map<uint64_t, std::vector<std::string>> dense_variable_name_;
...
class DownpourWorker : public HogwildWorker {
 public:
  ...
  virtual void Initilize(const DeviceWorkerDesc& desc);
  virtual void TrainFiles();
